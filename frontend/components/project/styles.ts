...
export const styles = StyleSheet.create({
  ...
  auditLogBtnText: { fontSize: 12, color: "rgba(255,255,255,0.7)", fontFamily: Fonts.semiBold },
  kebabBtn: {
    marginTop: 0,
    paddingHorizontal: 12,
    paddingVertical: 10,
  ...
  backArrow: { fontSize: 18, color: "rgba(255,255,255,0.7)" },
  ...
  subTabText: { fontSize: 13, fontFamily: Fonts.semiBold, color: "rgba(255,255,255,0.4)" },
  ...
  detailBackArrow: { fontSize: 20, color: "rgba(255,255,255,0.7)" },
  detailBackLabel: { fontSize: 13, color: "rgba(255,255,255,0.7)", fontFamily: Fonts.medium },
  detailTitleRow: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "center",
