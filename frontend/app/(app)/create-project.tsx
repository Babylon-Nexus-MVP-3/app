    ...
    try {
      const response = await fetchWithAuth("https://app-production-574c.up.railway.app/project", {
        ...
        body: JSON.stringify({
          ...
          ...(hasInsurance === "yes" && { creatorHasInsurance: true }),
          ...(hasInsurance === "no" && { creatorHasInsurance: false }),
          ...(hasLicence === "yes" && { creatorHasLicence: true }),
          ...(hasLicence === "no" && { creatorHasLicence: false }),
