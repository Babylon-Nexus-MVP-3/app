    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <View style={styles.content}>
        <View style={styles.iconCircle}>
          <Ionicons name="phone-portrait-outline" size={32} color={Colors.vouchGreen} />
        </View>

        <AppText style={styles.mobileNumber}>{displayMobile}</AppText>
        ...
        <AppText style={styles.hint}>
          Want to use a different number? Tap below to change it — you&apos;ll need to verify the
          new number via OTP.
        </AppText>
