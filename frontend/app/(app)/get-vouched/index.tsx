      ...
      {checkingProfile ? (
        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.requestList}>
            <AppText style={styles.requestListLabel}>REFERENCE STATUS</AppText>
            {loadingRequests ? (
              <ActivityIndicator color={Colors.vouchGreen} style={{ marginTop: 12 }} />
            ) : sentRequests.length === 0 ? (
              <AppText style={styles.requestMeta}>No requests found.</AppText>
            ) : (
              sentRequests.map((r) => {
                ...
                return (
                  <View key={r._id} style={styles.requestRow}>
                    ...
                    />
                    <View style={{ flex: 1 }}>
                      <AppText style={styles.requestMobile}>{r.toEmail || r.toMobile}</AppText>
...
const styles = StyleSheet.create({
  ...
  // Status screen — request list
  requestList: { width: "100%", marginTop: 8, gap: 12 },
  requestListLabel: {
    fontSize: 11,
    fontFamily: Fonts.bold,
  ...
  requestMobile: { fontSize: 14, fontFamily: Fonts.semiBold, color: Colors.black },
